...
class ClassPlainGeneratorTest {
	...
	def void testComplexClass() {
		...
		// generate files
		new ClassPlainGenerator(fsa, repository).generate()

		assertFileComparesToFixture(fsa, "../.debug/ZCL_JOH_GSST_CONV_ASST_FI.abap",
			"/fixtures/plain/ZCL_JOH_GSST_CONV_ASST_FI.abap")
